...
เข้าใจแล้วครับ 🙂
ผมจะออกแบบ **Template Prompt แบบสมบูรณ์** สำหรับสร้าง **Assessment Toolkit** ด้วย **Generative AI (เช่น GPT)**
ซึ่งครูสามารถนำไปใช้ได้กับทุกวิชา ทุกระดับชั้น และทุกหน่วยการเรียนรู้

**Assessment Toolkit** ที่เราจะสร้างด้วย Prompt นี้จะครอบคลุม 7 ส่วนหลัก:
...
ถ้าคุณต้องการ ผมสามารถสร้าง **Prompt Template อีกเวอร์ชัน** สำหรับ **ครูประถม** ที่ต้องการ **Assessment Toolkit + แบบฝึกเสริม + ข้อสอบ + Exit Tickets** รวมไว้ในคำสั่งเดียว

คุณอยากให้ผมทำเวอร์ชัน **All-in-One Prompt** สำหรับ **ออกแบบการสอน + การประเมิน** พร้อมกันเลยไหมครับ?
มันจะช่วยให้คุณได้ทั้ง **แผนสอน + Assessment Toolkit + แบบฝึกหัด + เฉลย** ในคำสั่งเดียว
